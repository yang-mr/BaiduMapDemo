...
public class MarkerActivity extends AppCompatActivity  implements SensorEventListener {
        ...
        AndPermission.with(this)
                ...
                .rationale(new RationaleListener() {
                    ...
                    public void showRequestPermissionRationale(int requestCode, Rationale rationale) {
                        AndPermission.rationaleDialog(MarkerActivity.this, rationale).show();
                    }
                })
                .callback(listener)
                .start();
    ...
    */
    private void setMarkers() {
        ...
        for (final InfoBean bean : list) {
            ...
            GlideUtil.showImgByUrl(this, view, bean, new GlideUtil.OnImageLoaded() {
                @Override
                public void imageLoaded(View markerView) {
                    //构建Marker图标
